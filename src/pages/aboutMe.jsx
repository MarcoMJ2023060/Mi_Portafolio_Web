        ...
        <div className="container mx-auto mt-[1rem]">
          <div className="sm:grid grid-cols-2 max-[1250px]:grid-cols-1">
            <div className="sm:p-10 p-5 bg-white sm:me-5 mb-10 rounded-md shadow-md h-[auto] ">
              <h3 className="text-2xl mb-5 font-bold">Un poco acerca mí</h3>
              <p className="leading-10 text-gray-500 text-2xl max-[750px]:text-[17px]">
                ¡Hola! Soy Marco Jose Bolaños, actualmente tengo 18 años de edad
                y soy un apasionado por la tecnología. <br /> <br /> Desde
                pequeño, me ha fascinado aprender constantemente y descubrir
                cómo funcionan las cosas. Me considero un joven entusiasta,
                siempre buscando mejorar día a día.
              </p>
            </div>
          </div>
        </div>
